...
const world = {
  settings: {
    ...
    gravity: { x: 0, y: 0.1 },
    bodyDefaults: { friction: 0.02, frictionAir: 0.06, frictionStatic: 0.4, restitution: 0.8, render: { fillStyle: 'red' } } // default parameters applied to a body
  },
  constellations: [{ // a constellation is a set of bodies or agents that relate to each other
    ...
    bodies: [
      { label: '0', render: { fillStyle: 'red' }, shape: 'circle', width: 30, height: 30, x: 40, y: 100 },
      { label: '1', render: { fillStyle: 'green' }, shape: 'circle', width: 40, height: 40, x: 200, y: 100 },
      { label: '2', render: { fillStyle: 'purple' }, shape: 'rectangle', friction: 0, frictionAir: 0.015, angle: 60, width: 300, height: 15, isSensor: true, x: 40, y: 300 }
    ]
  }
  // , {
  //   name: 'plink',
